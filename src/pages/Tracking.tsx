          ...
          {STEPS.map((step, index) => {
            ...
            return (
              <div key={step.id} className="flex items-start gap-6">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-500 border-4 border-white shadow-xl ${
                  isCompleted ? "bg-primary text-white" : "bg-gray-100 text-gray-300"
                }`}>
