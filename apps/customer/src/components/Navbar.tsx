              ...
              <AnimatePresence>
                {totalItems > 0 && (
                  <motion.span
                    ...
                    animate={{ scale: 1 }}
                    exit={{ scale: 0 }}
                    className="absolute -top-1 -right-1 md:left-5 md:right-auto w-[18px] h-[18px] md:w-5 md:h-5 rounded-full bg-gradient-to-br from-orange-500 to-red-600 text-white text-[10px] md:text-xs flex items-center justify-center font-bold shadow-md"
                  >
                    {totalItems}
                  </motion.span>
                )}
